...
from .views import ListagemProduto, DetalheProduto, RemoverProduto, Carrinho, FinalizarCarrinho, AdicionarProduto, BuscaProduto
...
urlpatterns = [
    ...
    path("busca", BuscaProduto.as_view(), name="busca-produto"),
]
